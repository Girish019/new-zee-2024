...
class Bot(Client):
    ...
    async def start(self):
        ...
        try:
            ...
            test = await self.send_message(chat_id = LOG_ID, text = RESTART_TXT.format(today, time))
           # await test.delete()
        ...
        self.LOGGER(__name__).info(f"current_bot_file_path = {os.path.abspath(__file__)} ")
